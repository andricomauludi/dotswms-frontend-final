...
const ButtonDeleteGroupProject = forwardRef(
  ({ parentFunction, tableData }, ref) => {
    ...
    const handleDelete = async () => {
      ...
      try {
        ...
        //   "/api/workspaces/deletegroupproject",
        //   payload
        // );

        const { data } = await axios.delete(
          BACKEND_PORT + "workspaces/delete-group-project/"+tableData._id,
          {
                  ...
                  <div className="mb-4.5">
                    <div>
                      <h1 className="text-large text-center text-black dark:text-white">
                        Are you sure want to delete this Group Project?
                      </h1>
                    </div>
                  </div>
                </div>
...
export default ButtonDeleteGroupProject;

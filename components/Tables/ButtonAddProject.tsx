...
export default function ButtonAddSubItem({ tableData }) {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    formData.append(
      "color_project",
      event.currentTarget.projectcolor.value
    );
    formData.append(
      "created_by",
      "admin1"
    ...
    try {
      const { data } = await axios.post("/api/workspaces/addproject", formData, {
        headers: {
                  ...
                  <div className="mb-4.5">
                    <div>
                      ...
                      <div className="relative z-20 bg-white dark:bg-form-input">
                        ...
                        >
                          <option value="border-l-6 border-warning">Yellow</option>
                          <option value="border-l-6 border-primary">Blue</option>
                          <option value="border-l-6 border-danger">Red</option>
                          <option value="border-l-6 border-secondary">Purple</option>

    ...
    <>
      <div className="relative z-20 h-35 md:h-65">
        <Image
          ...
          alt="profile cover"
          className=" bg-black h-full w-full rounded-tl-sm rounded-tr-sm object-cover object-center"
          width={970}
          height={260}
        />
      ...
      <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
        <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30  p-1 m:h-44 sm:max-w-44 sm:p-3">
          <div
            className="relative"
            style={{
              width: "120px",
        ...
        <div className="mt-4">
          ...
          <div
            className="mx-auto mt-4.5 mb-5.5 grid grid-cols-3 rounded-md border border-stroke py-2.5 shadow-1 dark:border-strokedark dark:bg-[#37404F]"
            style={{
          ...
          <div className="mx-auto max-w-180">
            ...
            <p className="mt-4.5">{data.address}</p>
          </div>
